 ...
 *
 * The router already renders RouteErrorComponent for anything a route's loader
 * or component throws, but that only covers the tree below RouterProvider.
 * Plugin loading, automerge storage, redux-persist rehydration and theme setup
 * all run above it, on the first-run path, against a stranger's browser — and a
 * throw from any of them would otherwise unmount the app to a blank page with
 * no way back.
 */
