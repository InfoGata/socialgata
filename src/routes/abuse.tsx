  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="rounded-lg border bg-card p-6 space-y-2">
        <h2 className="text-lg font-semibold">SocialGata stores nothing</h2>
        <p className="text-sm text-muted-foreground">
          SocialGata is a reader. When you open a feed, the plugin for that
          platform fetches from that platform directly, from your device, over
          your connection. No posts, images or comments are copied to us, and no
          server of ours sits in between. That limit is what shapes everything
          below.
        </p>
      </div>
